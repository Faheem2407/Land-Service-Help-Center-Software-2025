...
<div class="container-fluid">
    <div class="card p-4">
        <div class="d-flex justify-content-between mb-3">
            <h5 class="fw-semibold">সকল খরচের উৎস</h5>
            <a href="{{ route('admin.cost_sources.create') }}" class="btn btn-primary btn-lg">নতুন উৎস যোগ করুন</a>
        </div>
    ...
    window.showDeleteConfirm = function(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = '{{ route("admin.cost_sources.destroy", ":id") }}'.replace(':id', id);
                $.ajax({
                    url: url,
                    type: 'DELETE',
                    success: function(resp) {
                        if (resp.success) {
                            ...
                            table.ajax.reload();
                        } else toastr.error(resp.message || 'মুছতে ব্যর্থ হয়েছে।');
                    },
